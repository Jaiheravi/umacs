...
INLINE void pdumper_remember_scalar(void* data, ptrdiff_t nbytes) {
#ifdef HAVE_PDUMPER
...
/* Remember the pointer at *PTR.  *PTR must be null or point to a Lisp
   ...
   points.  */
INLINE void pdumper_remember_lv_ptr_raw(void* ptr, enum Lisp_Type type) {
#ifdef HAVE_PDUMPER
...
INLINE void pdumper_do_now_and_after_load(pdumper_hook hook) {
#ifdef HAVE_PDUMPER
...
INLINE void pdumper_do_now_and_after_late_load(pdumper_hook hook) {
#ifdef HAVE_PDUMPER
...
/* Return whether the OBJ points somewhere into the loaded dump image.
   ...
   returns false.  */
INLINE bool pdumper_object_p(const void* obj) {
#ifdef HAVE_PDUMPER
...
INLINE bool pdumper_cold_object_p(const void* obj) {
#ifdef HAVE_PDUMPER
...
INLINE int pdumper_find_object_type(const void* obj) {
#ifdef HAVE_PDUMPER
...
INLINE bool pdumper_valid_object_type_p(int type) { return 0 <= type; }
...
/* Return whether OBJ points exactly to the start of some object in
   ...
   false.  */
INLINE bool pdumper_object_p_precise(const void* obj) {
#ifdef HAVE_PDUMPER
...
INLINE bool pdumper_marked_p(const void* obj) {
#ifdef HAVE_PDUMPER
...
/* Set the pdumper mark bit for OBJ.  It is a programming error to
   ...
   would return false.  */
INLINE void pdumper_set_marked(const void* obj) {
#ifdef HAVE_PDUMPER
...
INLINE void pdumper_clear_marks(void) {
#ifdef HAVE_PDUMPER
