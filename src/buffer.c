...
static void CHECK_OVERLAY(Lisp_Object x) {
...
static void bset_abbrev_mode(struct buffer* b, Lisp_Object val) {
    b->abbrev_mode_ = val;
}
static void bset_abbrev_table(struct buffer* b, Lisp_Object val) {
    b->abbrev_table_ = val;
}
static void bset_auto_fill_function(struct buffer* b, Lisp_Object val) {
    b->auto_fill_function_ = val;
}
static void bset_auto_save_file_format(struct buffer* b, Lisp_Object val) {
    b->auto_save_file_format_ = val;
}
static void bset_auto_save_file_name(struct buffer* b, Lisp_Object val) {
    b->auto_save_file_name_ = val;
}
static void bset_backed_up(struct buffer* b, Lisp_Object val) {
    b->backed_up_ = val;
}
static void bset_begv_marker(struct buffer* b, Lisp_Object val) {
    b->begv_marker_ = val;
}
static void bset_bidi_display_reordering(struct buffer* b, Lisp_Object val) {
    b->bidi_display_reordering_ = val;
}
static void bset_bidi_paragraph_start_re(struct buffer* b, Lisp_Object val) {
    b->bidi_paragraph_start_re_ = val;
}
static void bset_bidi_paragraph_separate_re(struct buffer* b, Lisp_Object val) {
    b->bidi_paragraph_separate_re_ = val;
}
static void bset_buffer_file_coding_system(struct buffer* b, Lisp_Object val) {
    b->buffer_file_coding_system_ = val;
}
static void bset_ctl_arrow(struct buffer* b, Lisp_Object val) {
    b->ctl_arrow_ = val;
}
static void bset_cursor_in_non_selected_windows(struct buffer* b,
                                                Lisp_Object val) {
    b->cursor_in_non_selected_windows_ = val;
}
static void bset_cursor_type(struct buffer* b, Lisp_Object val) {
    b->cursor_type_ = val;
}
static void bset_display_table(struct buffer* b, Lisp_Object val) {
    b->display_table_ = val;
}
static void bset_extra_line_spacing(struct buffer* b, Lisp_Object val) {
    b->extra_line_spacing_ = val;
}
#ifdef HAVE_TREE_SITTER
static void bset_ts_parser_list(struct buffer* b, Lisp_Object val) {
    b->ts_parser_list_ = val;
}
#endif
static void bset_file_format(struct buffer* b, Lisp_Object val) {
    b->file_format_ = val;
}
static void bset_file_truename(struct buffer* b, Lisp_Object val) {
    b->file_truename_ = val;
}
static void bset_fringe_cursor_alist(struct buffer* b, Lisp_Object val) {
    b->fringe_cursor_alist_ = val;
}
static void bset_fringe_indicator_alist(struct buffer* b, Lisp_Object val) {
    b->fringe_indicator_alist_ = val;
}
static void bset_fringes_outside_margins(struct buffer* b, Lisp_Object val) {
    b->fringes_outside_margins_ = val;
}
static void bset_header_line_format(struct buffer* b, Lisp_Object val) {
    b->header_line_format_ = val;
}
static void bset_tab_line_format(struct buffer* b, Lisp_Object val) {
    b->tab_line_format_ = val;
}
static void bset_indicate_buffer_boundaries(struct buffer* b, Lisp_Object val) {
    b->indicate_buffer_boundaries_ = val;
}
static void bset_indicate_empty_lines(struct buffer* b, Lisp_Object val) {
    b->indicate_empty_lines_ = val;
}
static void bset_invisibility_spec(struct buffer* b, Lisp_Object val) {
    b->invisibility_spec_ = val;
}
static void bset_left_fringe_width(struct buffer* b, Lisp_Object val) {
    b->left_fringe_width_ = val;
}
static void bset_major_mode(struct buffer* b, Lisp_Object val) {
    b->major_mode_ = val;
}
static void bset_local_minor_modes(struct buffer* b, Lisp_Object val) {
    b->local_minor_modes_ = val;
}
static void bset_mark(struct buffer* b, Lisp_Object val) { b->mark_ = val; }
static void bset_mode_line_format(struct buffer* b, Lisp_Object val) {
    b->mode_line_format_ = val;
}
static void bset_mode_name(struct buffer* b, Lisp_Object val) {
    b->mode_name_ = val;
}
static void bset_name(struct buffer* b, Lisp_Object val) { b->name_ = val; }
static void bset_last_name(struct buffer* b, Lisp_Object val) {
    b->last_name_ = val;
}
static void bset_overwrite_mode(struct buffer* b, Lisp_Object val) {
    b->overwrite_mode_ = val;
}
static void bset_pt_marker(struct buffer* b, Lisp_Object val) {
    b->pt_marker_ = val;
}
static void bset_right_fringe_width(struct buffer* b, Lisp_Object val) {
    b->right_fringe_width_ = val;
}
static void bset_save_length(struct buffer* b, Lisp_Object val) {
    b->save_length_ = val;
}
static void bset_scroll_bar_width(struct buffer* b, Lisp_Object val) {
    b->scroll_bar_width_ = val;
}
static void bset_scroll_bar_height(struct buffer* b, Lisp_Object val) {
    b->scroll_bar_height_ = val;
}
static void bset_scroll_down_aggressively(struct buffer* b, Lisp_Object val) {
    b->scroll_down_aggressively_ = val;
}
static void bset_scroll_up_aggressively(struct buffer* b, Lisp_Object val) {
    b->scroll_up_aggressively_ = val;
}
static void bset_selective_display(struct buffer* b, Lisp_Object val) {
    b->selective_display_ = val;
}
static void bset_selective_display_ellipses(struct buffer* b, Lisp_Object val) {
    b->selective_display_ellipses_ = val;
}
static void bset_vertical_scroll_bar_type(struct buffer* b, Lisp_Object val) {
    b->vertical_scroll_bar_type_ = val;
}
static void bset_horizontal_scroll_bar_type(struct buffer* b, Lisp_Object val) {
    b->horizontal_scroll_bar_type_ = val;
}
static void bset_word_wrap(struct buffer* b, Lisp_Object val) {
    b->word_wrap_ = val;
}
static void bset_zv_marker(struct buffer* b, Lisp_Object val) {
    b->zv_marker_ = val;
}

void nsberror(Lisp_Object spec) {
    if (STRINGP(spec))
...
static Lisp_Object assoc_ignore_text_properties(Lisp_Object key,
                                                Lisp_Object list) {
    Lisp_Object tail;
...
(register Lisp_Object filename) {
    ...
    if (!NILP(handler)) {
        Lisp_Object handled_buf = calln(handler, Qget_file_buffer, filename);
        return BUFFERP(handled_buf) ? handled_buf : Qnil;
    }

    FOR_EACH_LIVE_BUFFER(tail, buf) {
        if (!STRINGP(BVAR(XBUFFER(buf), filename)))
            continue;
...
static void run_buffer_list_update_hook(struct buffer* buf) {
    eassert(buf);
...
static void add_buffer_overlay(struct buffer* b, struct Lisp_Overlay* ov,
...
static void copy_overlays(struct buffer* from, struct buffer* to) {
...
static void clone_per_buffer_values(struct buffer* from, struct buffer* to) {
    int offset;
...
static void record_buffer_markers(struct buffer* b) {
...
static void fetch_buffer_markers(struct buffer* b) {
    if (!NILP(BVAR(b, pt_marker))) {
        Lisp_Object m;
...
(Lisp_Object base_buffer, Lisp_Object name, Lisp_Object clone,
 Lisp_Object inhibit_buffer_hooks) {
    ...
    b->base_buffer =
        (XBUFFER(base_buffer)->base_buffer ? XBUFFER(base_buffer)->base_buffer
                                           : XBUFFER(base_buffer));
...
static void remove_buffer_overlay(struct buffer* b, struct Lisp_Overlay* ov) {
    eassert(b->overlays);
    eassert(ov->buffer == b);
...
static void drop_overlay(struct Lisp_Overlay* ov) {
    if (!ov->buffer)
        return;
...
void delete_all_overlays(struct buffer* b) {
    struct itree_node* node;
...
static void free_buffer_overlays(struct buffer* b) {
...
static void set_overlays_multibyte(bool multibyte) {
    ...
    for (int i = 0; i < size; ++i, ++nodes) {
        ...
        if (multibyte) {
            ...
            while (begin < Z_BYTE && !CHAR_HEAD_P(FETCH_BYTE(begin)))
                begin++;
            while (end < Z_BYTE && !CHAR_HEAD_P(FETCH_BYTE(end)))
                end++;
...
static void reset_buffer_local_variables(struct buffer* b, int permanent_too) {
                ...
                if (EQ(prop, Qpermanent_local_hook)) {
                    ...
                    if (XSYMBOL(local_var)->u.s.trapped_write ==
                        ...
                        notify_variable_watchers(
                            local_var, newlist, Qmakunbound, Fcurrent_buffer());
    ...
    FOR_EACH_PER_BUFFER_OBJECT_AT(offset) {
        ...
        if ((idx > 0 &&
             (permanent_too || buffer_permanent_local_flags[idx] == 0)))
...
(Lisp_Object buffer) { return BVAR(decode_buffer(buffer), last_name); }

DEFUN ("buffer-file-name", Fbuffer_file_name, Sbuffer_file_name, 0, 1, 0,
       doc: /* Return name of file BUFFER is visiting, or nil if none.
No argument or nil as argument means use the current buffer.  */)
(register Lisp_Object buffer) { return BVAR(decode_buffer(buffer), filename); }
...
Lisp_Object buffer_local_value(Lisp_Object variable, Lisp_Object buffer) {
...
start:
    ...
    case SYMBOL_LOCALIZED:
        { /* Look in local_var_alist.  */
            ...
            if (!NILP(result)) {
                if (blv->fwd) { /* What binding is loaded right now?  */
...
static Lisp_Object buffer_lisp_local_variables(struct buffer* buf, bool clone) {
    ...
    for (tail = BVAR(buf, local_var_alist); CONSP(tail); tail = XCDR(tail)) {
       ...
       for that buffer, making the alist up to date automatically.  */
        ...
        result = Fcons(!clone && BASE_EQ(val, Qunbound) ? XCAR(elt)
                                                        : Fcons(XCAR(elt), val),
                       result);
    }
...
(Lisp_Object flag) {
    ...
    struct buffer* b = current_buffer->base_buffer ? current_buffer->base_buffer
                                                   : current_buffer;
...
static bool candidate_buffer(Lisp_Object b, Lisp_Object buffer) {
    return (BUFFERP(b) && !BASE_EQ(b, buffer) && BUFFER_LIVE_P(XBUFFER(b)) &&
...
(Lisp_Object buffer, Lisp_Object visible_ok, Lisp_Object frame) {
    ...
    for (; CONSP(tail); tail = XCDR(tail)) {
        ...
        if (candidate_buffer(buf, buffer)
            ...
            if (!NILP(visible_ok) || NILP(Fget_buffer_window(buf, Qvisible)))
                return buf;
...
Lisp_Object other_buffer_safely(Lisp_Object buffer) {
...
void compact_buffer(struct buffer* buffer) {
    ...
    if (BUFFER_LIVE_P(buffer) && (buffer->base_buffer == NULL) &&
       ...
       So don't call truncate_undo_list if undo_list is Qt.  */
        ...
        if (!buffer->text->inhibit_shrinking) {
            ...
            ptrdiff_t size = clip_to_bounds(
                GAP_BYTES_MIN, BUF_Z_BYTE(buffer) / 10, GAP_BYTES_DFL);
...
(Lisp_Object buffer_or_name) {
    ...
    /* Run hooks with the buffer to be killed as the current buffer.  */
    {
        ...
        modified =
            !NILP(BVAR(b, filename)) && BUF_MODIFF(b) > BUF_SAVE_MODIFF(b);
        ...
        if (modified && kill_buffer_delete_auto_save_files &&
            delete_auto_save_files && !NILP(Frecent_auto_save_p()) &&
        ...
        FOR_EACH_LIVE_BUFFER(tail, other) {
            ...
            if (obuf->base_buffer == b) {
                ...
                if (BUFFER_LIVE_P(obuf))
                    error("Unable to kill buffer whose indirect buffer `%s' "
                          "cannot be killed",
...
void record_buffer(Lisp_Object buffer) {
...
DEFUN("bury-buffer-internal", Fbury_buffer_internal, Sbury_buffer_internal, 1,
      1, 0, doc:/* Move BUFFER to the end of the buffer list.  */)
(Lisp_Object buffer) {
    Lisp_Object aelt, aelt_cons, tem;
    register struct frame* f = XFRAME(selected_frame);
...
void set_buffer_internal_1(register struct buffer* b) {
...
void set_buffer_temp(struct buffer* b) {
    register struct buffer* old_buf;
...
void restore_buffer(Lisp_Object buffer_or_name) { Fset_buffer(buffer_or_name); }

/* Set the current buffer to BUFFER provided if it is alive.  */

void set_buffer_if_live(Lisp_Object buffer) {
    if (BUFFER_LIVE_P(XBUFFER(buffer)))
        set_buffer_internal(XBUFFER(buffer));
}
...
(Lisp_Object position) {
    ...
    if (!NILP(BVAR(current_buffer, read_only)) && NILP(Vinhibit_read_only) &&
...
void validate_region(Lisp_Object* b, Lisp_Object* e) {
...
ptrdiff_t advance_to_char_boundary(ptrdiff_t byte_pos) {
    int c;
...
static void swap_buffer_overlays(struct buffer* buffer, struct buffer* other) {
    struct itree_node* node;
...
(Lisp_Object buffer) {
     ...
     *both* indirect.  */
    if (other_buffer->base_buffer || current_buffer->base_buffer)
...
#define swapfield_(field, type)                                                \
    ...
    { /* Some of the C code expects that both window markers of a
        ...
        XSETBUFFER(buf1, current_buffer);
        XSETBUFFER(buf2, other_buffer);
        ...
        while (NILP(Fmemq(w, ws))) {
            ...
            if (MARKERP(XWINDOW(w)->pointm) &&
                ...
                Fset_marker(
                    XWINDOW(w)->pointm,
                    make_fixnum(BUF_BEGV(XBUFFER(XWINDOW(w)->contents))),
                    XWINDOW(w)->contents);
    ...
    if (other_buffer->text->intervals)
        (eassert(
             BASE_EQ(other_buffer->text->intervals->up.obj, Fcurrent_buffer())),
...
(Lisp_Object flag) {
    ...
    if (NILP(flag)) {
       ...
       Ex: We change this: "...abc\302 _GAP_ \241def..."
        ...
        if (EQ(flag, Qt) && GPT_BYTE > 1 && GPT_BYTE < Z_BYTE &&
            !CHAR_HEAD_P(*(GAP_END_ADDR))) {
            unsigned char* q = GPT_ADDR - 1;

            while (!CHAR_HEAD_P(*q) && q > BEG_ADDR)
                q--;
            if (LEADING_CODE_P(*q)) {
    ...
    if (!EQ(old_undo, Qt)) {
        ...
        bset_undo_list(
            current_buffer,
            Fcons(list3(Qapply, Qset_buffer_multibyte, NILP(flag) ? Qt : Qnil),
                  old_undo));
    }
...
static ptrdiff_t overlays_in(ptrdiff_t beg, ptrdiff_t end, bool extend,
                             Lisp_Object** vec_ptr, ptrdiff_t* len_ptr,
                             bool empty, bool trailing, ptrdiff_t* next_ptr) {
    ptrdiff_t idx = 0;
    ...
    ITREE_FOREACH(node, current_buffer->overlays, beg, search_end, ASCENDING) {
        if (node->begin > end) {
        ...
        if (extend && idx == len) {
            vec = xpalloc(vec, len_ptr, 1, OVERLAY_COUNT_MAX, sizeof *vec);
            *vec_ptr = vec;
            len = *len_ptr;
        }
        if (idx < len)
...
ptrdiff_t overlays_at(ptrdiff_t pos, bool extend, Lisp_Object** vec_ptr,
                      ptrdiff_t* len_ptr, ptrdiff_t* next_ptr) {
    return overlays_in(pos, pos + 1, extend, vec_ptr, len_ptr, false, true,
                       next_ptr);
}

ptrdiff_t next_overlay_change(ptrdiff_t pos) {
    ptrdiff_t next = ZV;
    struct itree_node* node;

    ITREE_FOREACH(node, current_buffer->overlays, pos, next, ASCENDING) {
        if (node->begin > pos) {
            /* If we reach this branch, node->begin must be the least upper
               bound of pos, because the search is limited to [pos,next) . */
...
static ptrdiff_t previous_overlay_change(ptrdiff_t pos) {
    struct itree_node* node;
    ptrdiff_t prev = BEGV;
...
bool mouse_face_overlay_overlaps(Lisp_Object overlay) {
    ptrdiff_t start = OVERLAY_START(overlay);
    ptrdiff_t end = OVERLAY_END(overlay);
    Lisp_Object tem;
    struct itree_node* node;

    ITREE_FOREACH(node, current_buffer->overlays, start, min(end, ZV) + 1,
                  ASCENDING) {
        if (node->begin < end && node->end > start && node->begin < node->end &&
            !BASE_EQ(node->data, overlay) &&
            (tem = Foverlay_get(overlay, Qmouse_face), !NILP(tem)))
            return true;
    }
    return false;
}
...
bool disable_line_numbers_overlay_at_eob(void) {
...
*/
bool overlay_touches_p(ptrdiff_t pos) {
    struct itree_node* node;
...
ptrdiff_t sort_overlays(Lisp_Object* overlay_vec, ptrdiff_t noverlays,
                        struct window* w) {
    ptrdiff_t i, j;
    USE_SAFE_ALLOCA;
    ...
    for (i = 0, j = 0; i < noverlays; i++) {
        ...
        if (OVERLAYP(overlay) && OVERLAY_START(overlay) > 0 &&
...
static int cmp_for_strings(const void* as1, const void* as2) {
...
static void record_overlay_string(struct sortstrlist* ssl, Lisp_Object str,
                                  Lisp_Object str2, Lisp_Object pri,
                                  ptrdiff_t size) {
    ptrdiff_t nbytes;
    ...
    if (NILP(BVAR(current_buffer, enable_multibyte_characters)))
        ...
        nbytes = count_size_as_multibyte(SDATA(str), SBYTES(str));
    else
        nbytes = SBYTES(str);
    ...
    if (STRINGP(str2)) {
        if (NILP(BVAR(current_buffer, enable_multibyte_characters)))
            ...
            nbytes = count_size_as_multibyte(SDATA(str2), SBYTES(str2));
        else
            nbytes = SBYTES(str2);
...
ptrdiff_t overlay_strings(ptrdiff_t pos, struct window* w,
                          unsigned char** pstr) {
    ...
    ITREE_FOREACH(node, current_buffer->overlays, pos - 1, pos + 1,
                  DESCENDING) {
        ...
        if (startpos == pos &&
            ...
            record_overlay_string(
                &overlay_heads, str,
                (startpos == endpos ? Foverlay_get(overlay, Qafter_string)
                                    : Qnil),
                Foverlay_get(overlay, Qpriority), endpos - startpos);
        else if (endpos == pos &&
    ...
    if (overlay_heads.bytes || overlay_tails.bytes) {
        ...
        for (i = overlay_tails.used; --i >= 0;) {
            ...
            nbytes = copy_text(SDATA(tem), p, SBYTES(tem),
...
void adjust_overlays_for_insert(ptrdiff_t pos, ptrdiff_t length,
                                bool before_markers) {
...
static void adjust_overlays_for_delete_in_buffer(struct buffer* buf,
                                                 ptrdiff_t pos,
                                                 ptrdiff_t length) {
...
void adjust_overlays_for_delete(ptrdiff_t pos, ptrdiff_t length) {
    if (!current_buffer->indirections)
...
(Lisp_Object object) { return (OVERLAYP(object) ? Qt : Qnil); }
...
static void modify_overlay(struct buffer* buf, ptrdiff_t start, ptrdiff_t end) {
    if (start > end) {
...
(Lisp_Object overlay, Lisp_Object beg, Lisp_Object end, Lisp_Object buffer) {
    ...
    if (!BASE_EQ(buffer, obuffer)) {
        ...
        itree_node_set_region(b->overlays, XOVERLAY(overlay)->interval, n_beg,
                              n_end);
    ...
    if (n_beg == n_end &&
        !NILP(Foverlay_get(
            overlay,
            Qevaporate))) { /* We used to call `Fdelete_overlay' here, but it
                               causes problems:
                               - At this stage, `overlay' is not included in its
                               buffer's lists of overlays (the data-structure is
                               in an inconsistent state), contrary to
                               `Fdelete_overlay's assumptions.
                               - Most of the work done by Fdelete_overlay has
                               already been done here for other reasons.  */
...
static void add_overlay_mod_hooklist(Lisp_Object functionlist,
                                     Lisp_Object overlay) {
...
void report_overlay_modification(Lisp_Object start, Lisp_Object end, bool after,
    ...
    if (!after) {
       ...
       Scan the overlays to find the functions to call.  */
        ...
        ITREE_FOREACH(node, current_buffer->overlays,
                      ...
                      end_arg + (insertion ? 1 : 0), ASCENDING) {
            Lisp_Object overlay = node->data;
            ptrdiff_t obegin = OVERLAY_START(overlay);
            ptrdiff_t oend = OVERLAY_END(overlay);

            if (insertion && (begin_arg == obegin || end_arg == obegin)) {
                Lisp_Object prop =
                    Foverlay_get(overlay, Qinsert_in_front_hooks);
                if (!NILP(prop))
                    add_overlay_mod_hooklist(prop, overlay);
            }
            if (insertion && (begin_arg == oend || end_arg == oend)) {
...
#define MMAP_REGION_STRUCT_SIZE ROUND(sizeof(struct mmap_region), MEM_ALIGN)
...
#define MMAP_USER_AREA(P) ((void*)((char*)(P) + MMAP_REGION_STRUCT_SIZE))
...
static void mmap_free_1(struct mmap_region* r) {
    if (r->next)
        r->next->prev = r->prev;
    if (r->prev)
        r->prev->next = r->next;
...
static bool mmap_enlarge(struct mmap_region* r, int npages) {
...
static void* mmap_alloc(void** var, size_t nbytes) {
    void* p;
    size_t map;
    ...
    p = mmap(NULL, map, PROT_READ | PROT_WRITE, MAP_ANON | MAP_PRIVATE, mmap_fd,
             0);
...
static void mmap_free(void** var) {
    mmap_init();
...
static void* mmap_realloc(void** var, size_t nbytes) {
    void* result;
    ...
    if (*var == NULL)
        ...
        if (room < nbytes) {
            ...
            if (mmap_enlarge(
                    r,
                    (ROUND(nbytes - room, mmap_page_size) / mmap_page_size))) {
                r->nbytes_specified = nbytes;
                *var = result = old_ptr;
            }
...
static void alloc_buffer_text(struct buffer* b, ptrdiff_t nbytes) {
    void* p;
...
void enlarge_buffer_text(struct buffer* b, ptrdiff_t delta) {
    block_input();
    void* p;
...
void init_buffer_once(void) {
    ...
    */
    ...
    memset(buffer_permanent_local_flags, 0,
    ...
    idx = 1;
    XSETFASTINT(BVAR(&buffer_local_flags, mode_line_format), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, abbrev_mode), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, overwrite_mode), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, auto_fill_function), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, selective_display), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, selective_display_ellipses), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, tab_width), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, truncate_lines), idx);
    /* Make this one a permanent local.  */
    buffer_permanent_local_flags[idx++] = 1;
    XSETFASTINT(BVAR(&buffer_local_flags, word_wrap), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, ctl_arrow), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, fill_column), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, left_margin), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, abbrev_table), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, display_table), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, syntax_table), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, cache_long_scans), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, category_table), idx);
    ++idx;
    ...
    /* Make this one a permanent local.  */
    buffer_permanent_local_flags[idx++] = 1;
    XSETFASTINT(BVAR(&buffer_local_flags, left_margin_cols), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, right_margin_cols), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, left_fringe_width), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, right_fringe_width), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, fringes_outside_margins), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, scroll_bar_width), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, scroll_bar_height), idx);
    ++idx;
    ...
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, indicate_empty_lines), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, indicate_buffer_boundaries), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, fringe_indicator_alist), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, fringe_cursor_alist), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, scroll_up_aggressively), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, scroll_down_aggressively), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, header_line_format), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, tab_line_format), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, cursor_type), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, extra_line_spacing), idx);
    ++idx;
#ifdef HAVE_TREE_SITTER
    XSETFASTINT(BVAR(&buffer_local_flags, ts_parser_list), idx);
    ++idx;
#endif
    XSETFASTINT(BVAR(&buffer_local_flags, text_conversion_style), idx);
    ++idx;
    XSETFASTINT(BVAR(&buffer_local_flags, cursor_in_non_selected_windows), idx);
    ++idx;
...
void init_buffer(void) {
    ...
    if (!pwd) {
        ...
        if (!NILP(temp)
            ...
            bset_directory(
                current_buffer,
                concat2(slash_colon, BVAR(current_buffer, directory)));
        }
    }
...
#define DEFVAR_PER_BUFFER(lname, vname, predicate_, doc)                       \
    do {                                                                       \
        static const struct Lisp_Fwd bo_fwd = {                                \
            ...
            .u.buf = {.offset = offsetof(struct buffer, vname##_),             \
...
static void defvar_per_buffer(const struct Lisp_Fwd* fwd,
...
#ifdef ITREE_DEBUG
static Lisp_Object make_lispy_itree_node(const struct itree_node* node) {
    return list(intern(":begin"), make_fixnum(node->begin), intern(":end"),
                make_fixnum(node->end), intern(":limit"),
                make_fixnum(node->limit), intern(":offset"),
                make_fixnum(node->offset), intern(":rear-advance"),
                node->rear_advance ? Qt : Qnil, intern(":front-advance"),
                node->front_advance ? Qt : Qnil);
}

static Lisp_Object overlay_tree(const struct itree_tree* tree,
                                const struct itree_node* node) {
    if (node == ITREE_NULL)
        return Qnil;
    return list3(make_lispy_itree_node(node), overlay_tree(tree, node->left),
...
void syms_of_buffer(void) {
    ...
    Fput(Qoverwrite_mode, Qchoice,
         list3(Qnil, intern("overwrite-mode-textual"), Qoverwrite_mode_binary));

    Fput(Qprotected_field, Qerror_conditions, list(Qprotected_field, Qerror));
...
it is not marked as "special".  */);
    ...
    DEFVAR_PER_BUFFER("local-minor-modes", local_minor_modes, Qnil, doc:
                          /* Minor modes currently active in the current
        buffer. This is a list of symbols, or nil if there are no minor modes
        active.  */);
...
mode by default in all buffers.  */);
    ...
    DEFVAR_PER_BUFFER("fill-column", fill_column, Qintegerp,
                      doc
...
Linefeed indents to this column in Fundamental mode.  */);
    ...
    DEFVAR_PER_BUFFER(
        "tab-width", tab_width, Qintegerp,
        doc:/* Distance between tab stops (for display of tab characters), in
columns. This controls the width of a TAB character on display. The value
should be a positive integer. Note that this variable doesn't necessarily
affect the size of the indentation step.  However, if the major mode's
indentation facility inserts one or more TAB characters, this variable will
affect the indentation step as well, even if `indent-tabs-mode' is non-nil.
*/);
...
See also Info node `(elisp)Text Representations'.  */);
    ...
    DEFVAR_PER_BUFFER("buffer-file-coding-system", buffer_file_coding_system,
                      Qnil,
                      doc
...
`visual-line-mode'.  */);
    ...
    DEFVAR_PER_BUFFER("default-directory", directory, Qstringp, doc:
...
:/* Non-nil means display ... on previous line when a line is invisible.  */);
    ...
    DEFVAR_PER_BUFFER("overwrite-mode", overwrite_mode, Qoverwrite_mode, doc:
                          /* Non-nil if self-insertion should replace existing
        text. The value should be one of `overwrite-mode-textual',
        `overwrite-mode-binary', or nil.
        If it is `overwrite-mode-textual', self-insertion still
        inserts at the end of a line, and inserts when point is before a tab,
        until the tab is filled in.
        If `overwrite-mode-binary', self-insertion replaces newlines and tabs
        too.  */);
...
specifies.  */);
    ...
    DEFVAR_PER_BUFFER(
        "indicate-empty-lines", indicate_empty_lines, Qnil, doc:
            /* Visually indicate unused ("empty") screen lines after the buffer
end. If non-nil, a bitmap is displayed in the left fringe of a window on
graphical displays for each screen line that doesn't correspond to any buffer
text.  */);
...
symbol which is used in both left and right fringes.  */);
    ...
    DEFVAR_PER_BUFFER("fringe-cursor-alist", fringe_cursor_alist, Qnil, doc:
                          /* Mapping from logical to physical fringe cursor
        bitmaps. The value is an alist where each element (CURSOR . BITMAP)
        specifies the fringe bitmaps used to display a specific logical
...
from happening repeatedly and making Emacs nonfunctional.  */);
    ...
    DEFVAR_LISP("first-change-hook", Vfirst_change_hook, doc:
                    /* A list of functions to call before changing a buffer
    which is unmodified. The functions are run using the `run-hooks' function.
  */);
    Vfirst_change_hook = Qnil;

    DEFVAR_PER_BUFFER("buffer-undo-list", undo_list, Qnil, doc:
        ...
        An entry (t . -1) is similar, except that it means the buffer's
        visited file did not exist.
        ...
        and DELTA is the number of characters added or deleted in that range
        by this change.
...
the buffer looking for properties to change.  */);
    ...
    DEFVAR_PER_BUFFER("buffer-display-count", display_count, Qintegerp, doc:
                          /* A number incremented each time this buffer is
        displayed in a window. The function `set-window-buffer' increments it.
      */);
...
If `delete-auto-save-files' is nil, any autosave deletion is inhibited.  */);
    ...
    DEFVAR_BOOL("delete-auto-save-files", delete_auto_save_files, doc:
                    /* Non-nil means delete auto-save file when a buffer is
    saved. This is the default.  If nil, auto-save file deletion is inhibited.
  */);
...
There is no reason to change that value except for debugging purposes.  */);
    ...
    DEFVAR_INT("large-hscroll-threshold", large_hscroll_threshold, doc:
                   /* Horizontal scroll of truncated lines above which to use
          redisplay shortcuts.

          The value should be a positive integer.

          Shortcuts in the display code intended to speed up redisplay for
          long and truncated lines will automatically be enabled when a
          line's horizontal scroll amount is or about to become larger than
