...
#define EMACS_LIMB_MAX SIZE_MAX
    ...
    struct emacs_env_25 {
        ...
        emacs_value (*make_string)(emacs_env* env, const char* str,
                                   ptrdiff_t len) EMACS_ATTRIBUTE_NONNULL(1, 2);

        /* Embedded pointer type.  */
        emacs_value (*make_user_ptr)(emacs_env* env,
                                     void (*fin)(void*) EMACS_NOEXCEPT,
                                     void* ptr) EMACS_ATTRIBUTE_NONNULL(1);
        ...
        /* Vector functions.  */
        emacs_value (*vec_get)(emacs_env* env, emacs_value vector,
                               ptrdiff_t index) EMACS_ATTRIBUTE_NONNULL(1);
    ...
    struct emacs_env_27 {
        ...
        emacs_value (*make_big_integer)(emacs_env* env, int sign,
                                        ptrdiff_t count,
    ...
    struct emacs_env_28 {
        ...
        void (*(*EMACS_ATTRIBUTE_NONNULL(1) get_function_finalizer)(
