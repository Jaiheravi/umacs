...
static void set_canon(Lisp_Object case_table, Lisp_Object range,
                      Lisp_Object elt);
...
static Lisp_Object check_case_table(Lisp_Object obj) {
...
(Lisp_Object table) { return set_case_table(table, 0); }
...
static Lisp_Object set_case_table(Lisp_Object table, bool standard) {
    Lisp_Object up, canon, eqv;
