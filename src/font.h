...
INLINE struct font* CHECK_FONT_GET_OBJECT(Lisp_Object x) {
    CHECK_FONT_OBJECT(x);
...
struct font_driver {
    ...
    /* Compute the total metrics of the NGLYPHS glyphs specified by
       ...
       result in METRICS.  */
    void (*text_extents)(struct font* font, const unsigned* code, int nglyphs,
    ...
    int (*anchor_point)(struct font* font, unsigned code, int index, int* x,
                        int* y);
...
extern Lisp_Object font_open_for_lface(struct frame* f, Lisp_Object entity,
                                       Lisp_Object* lface, Lisp_Object spec);
...
extern void font_parse_family_registry(Lisp_Object family, Lisp_Object registry,
                                       Lisp_Object spec);
...
#else
INLINE bool valid_font_driver(struct font_driver const* d) { return true; }
#endif
extern Lisp_Object font_update_drivers(struct frame* f, Lisp_Object list);
extern Lisp_Object font_range(ptrdiff_t, ptrdiff_t, ptrdiff_t*, struct window*,
                              struct face*, Lisp_Object, int);
...
extern void font_filter_properties(Lisp_Object font, Lisp_Object alist,
...
#ifdef HAVE_FREETYPE
extern int ftfont_anchor_point(struct font*, unsigned int, int, int*, int*);
extern int ftfont_get_bitmap(struct font*, unsigned int, struct font_bitmap*,
                             int);
...
/* FIXME: This is for use in functions that can be called while
   ...
   (Bug#20890).  */
INLINE bool font_data_structures_may_be_ill_formed(void) {
#if defined USE_CAIRO || defined USE_BE_CAIRO
