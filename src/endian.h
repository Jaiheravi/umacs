...
/* These declarations are needed if Gnulib byteswap.h -> stdint.h ->
   ...
   by its include guard so the functions are not yet declared.  */
    ...
    _GL_ENDIAN_INLINE uint16_t be16toh(uint16_t x) {
    ...
    _GL_ENDIAN_INLINE uint32_t be32toh(uint32_t x) {
#if BYTE_ORDER == BIG_ENDIAN
        return x;
#else
    return bswap_32(x);
...
#ifdef UINT64_MAX
    _GL_ENDIAN_INLINE uint64_t be64toh(uint64_t x) {
#if BYTE_ORDER == BIG_ENDIAN
        return x;
#else
        return bswap_64(x);
    ...
    _GL_ENDIAN_INLINE uint16_t htobe16(uint16_t x) {
#if BYTE_ORDER == BIG_ENDIAN
        return x;
#else
    return bswap_16(x);
    ...
    _GL_ENDIAN_INLINE uint32_t htobe32(uint32_t x) {
#if BYTE_ORDER == BIG_ENDIAN
        return x;
#else
    return bswap_32(x);
...
#ifdef UINT64_MAX
    _GL_ENDIAN_INLINE uint64_t htobe64(uint64_t x) {
#if BYTE_ORDER == BIG_ENDIAN
        return x;
#else
        return bswap_64(x);
    ...
    _GL_ENDIAN_INLINE uint16_t le16toh(uint16_t x) {
#if BYTE_ORDER == BIG_ENDIAN
        return bswap_16(x);
#else
    return x;
    ...
    _GL_ENDIAN_INLINE uint32_t le32toh(uint32_t x) {
#if BYTE_ORDER == BIG_ENDIAN
        return bswap_32(x);
#else
    return x;
...
#ifdef UINT64_MAX
    _GL_ENDIAN_INLINE uint64_t le64toh(uint64_t x) {
#if BYTE_ORDER == BIG_ENDIAN
        return bswap_64(x);
#else
        return x;
    ...
    _GL_ENDIAN_INLINE uint16_t htole16(uint16_t x) {
#if BYTE_ORDER == BIG_ENDIAN
        return bswap_16(x);
#else
    return x;
    ...
    _GL_ENDIAN_INLINE uint32_t htole32(uint32_t x) {
#if BYTE_ORDER == BIG_ENDIAN
        return bswap_32(x);
#else
    return x;
...
#ifdef UINT64_MAX
    _GL_ENDIAN_INLINE uint64_t htole64(uint64_t x) {
#if BYTE_ORDER == BIG_ENDIAN
        return bswap_64(x);
#else
        return x;
