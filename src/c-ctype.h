...
extern "C"
{
    ...
    /* The functions defined in this file assume the "C" locale and a character
       ...
       ASCII character set (like on BeOS, where it is UTF-8, or on AmigaOS,
       where it is ISO-8859-1), the functions in this file recognize only the
       ASCII characters.  */
...
#define _C_CTYPE_UPPER _C_CTYPE_LOWER_N('A' - 'a')
    ...
    /* Unlike the functions in <ctype.h>, which require an argument in the range
       of the 'unsigned char' type, the functions here operate on values that
       are in the 'unsigned char' range or in the 'char' range.  In other words,
