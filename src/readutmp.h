...
#define UT_EXIT_E_EXIT(UT) ((UT)->ut_exit.e_exit)
    ...
    /* <utmpx.h> defines 'struct utmpx' with the following fields:
         ...
         ----------   ------                     ---------
       ⎡ ut_user      char[]                     glibc, musl, macOS, FreeBSD,
       AIX, HP-UX, Solaris, Cygwin, Android ⎣ ut_name      char[] NetBSD, Minix
         ut_id        char[]                     glibc, musl, macOS, FreeBSD,
       NetBSD, Minix, AIX, HP-UX, Solaris, Cygwin, Android ut_line      char[]
       glibc, musl, macOS, FreeBSD, NetBSD, Minix, AIX, HP-UX, Solaris, Cygwin,
       Android ut_pid       pid_t                      glibc, musl, macOS,
       FreeBSD, NetBSD, Minix, AIX, HP-UX, Solaris, Cygwin, Android ut_type
       short                      glibc, musl, macOS, FreeBSD, NetBSD, Minix,
       AIX, HP-UX, Solaris, Cygwin, Android ⎡ ut_tv        struct glibc, musl,
       macOS, FreeBSD, NetBSD, Minix, AIX, HP-UX, Solaris, Cygwin, Android ⎢ {
       tv_sec; tv_usec; } ⎣ ut_time      time_t                     Cygwin
         ut_host      char[]                     glibc, musl, macOS, FreeBSD,
       NetBSD, Minix, AIX, HP-UX, Solaris, Cygwin, Android ut_exit      struct
       glibc, musl, NetBSD, Minix, HP-UX, Solaris, Android { e_termination;
       e_exit; } ut_session   [long] int                 glibc, musl, NetBSD,
       Minix, Solaris, Android ⎡ ut_addr      [long] int                 HP-UX,
       Cygwin ⎢ ut_addr_v6   [u]int[4]                  glibc, musl, Android ⎣
...
#define _GL_UT_HOST_SIZE sizeof(((struct utmpx*)0)->ut_host)
    struct utmpx32 {
        ...
        struct {
            /* Seconds.  Unsigned not signed, as glibc did not exist before
               1970, and if the format is still in use after 2038 its timestamps
...
/* <utmp.h> defines 'struct utmp' with the following fields:
     ...
     Field        Type                       Platforms
     ----------   ------                     ---------
   ⎡ ut_user      char[]                     glibc, musl, AIX, HP-UX, Solaris,
   Cygwin, Android ⎣ ut_name      char[]                     macOS, old FreeBSD,
   NetBSD, OpenBSD, Minix ut_id        char[]                     glibc, musl,
   AIX, HP-UX, Solaris, Cygwin, Android ut_line      char[] glibc, musl, macOS,
   old FreeBSD, NetBSD, OpenBSD, Minix, AIX, HP-UX, Solaris, Cygwin, Android
     ut_pid       pid_t                      glibc, musl, AIX, HP-UX, Solaris,
   Cygwin, Android ut_type      short                      glibc, musl, AIX,
   HP-UX, Solaris, Cygwin, Android ⎡ ut_tv        struct glibc, musl, Android ⎢
   { tv_sec; tv_usec; } ⎣ ut_time      time_t                     macOS, old
   FreeBSD, NetBSD, OpenBSD, Minix, AIX, HP-UX, Solaris, Cygwin ut_host char[]
   glibc, musl, macOS, old FreeBSD, NetBSD, OpenBSD, Minix, AIX, HP-UX, Cygwin,
   Android ut_exit      struct                     glibc, musl, AIX, HP-UX,
   Solaris, Android { e_termination; e_exit; } ut_session   [long] int glibc,
   musl, Android ⎡ ut_addr      [long] int                 HP-UX, Cygwin ⎣
...
#ifdef HAVE_UTMPNAME /* glibc, musl, NetBSD, Minix, AIX, HP-UX, Solaris,       \
                        Cygwin, Android */
...
#define IS_USER_PROCESS(UT) ((UT)->ut_user[0] && UT_TYPE_USER_PROCESS(UT))
...
#define READ_UTMP_SUPPORTED 1
    ...
    char* extract_trimmed_name(const STRUCT_UTMP* ut) _GL_ATTRIBUTE_MALLOC
